...
export async function clientRequest(
  ...
  try {
    ...
    // Flagged so callers can tell "the server rejected this" (show
    // inline, next to the field/form that caused it) apart from "we
    // couldn't even reach it" (a toast reads better -- it's not about
